...
public class CaptureScreenshot {
    ...
    public void captureScreenshotTest() throws InterruptedException {
        ...
        try {
            FileHandler.copy(takesScreenshot.getScreenshotAs(OutputType.FILE), new File("C:\\Users\\harshal bojja\\IdeaProjects\\SeleniumSession\\src\\screenshot\\screenshot_"+System.currentTimeMillis()+".png"));
